...
case OPCODE_OP_FP:
  switch (funct7) {
    ...
    // DECLARECASE(FUNCT7_FSGNJ_S, INSTRUCT_FSGNJ_S)
    // DECLARECASE(FUNCT7_FSGNJN_S, INSTRUCT_FSGNJN_S)
    // DECLARECASE(FUNCT7_FSGNJX_S, INSTRUCT_FSGNJX_S)
    // DECLARECASE(FUNCT7_FMIN_S, INSTRUCT_FMIN_S)
    // DECLARECASE(FUNCT7_FMAX_S, INSTRUCT_FMAX_S)
    // DECLARECASE(FUNCT7_FCVT_W_S, INSTRUCT_FCVT_W_S)
    // DECLARECASE(FUNCT7_FCVT_WU_S, INSTRUCT_FCVT_WU_S)
  case FUNCT7_FMV_X_W:
    switch (funct3) {
    ...
    break;
    // DECLARECASE(FUNCT7_FEQ_S   , INSTRUCT_FEQ_S   )
    // DECLARECASE(FUNCT7_FLT_S   , INSTRUCT_FLT_S   )
    // DECLARECASE(FUNCT7_FLE_S   , INSTRUCT_FLE_S   )
    // DECLARECASE(FUNCT7_FCVT_S_W, INSTRUCT_FCVT_S_W)
    // DECLARECASE(FUNCT7_FCVT_S_WU, INSTRUCT_FCVT_S_WU)
    DECLARECASE(FUNCT7_FMV_W_X, INSTRUCT_FMV_W_X)
    // DECLARECASE(FUNCT7_FCVT_L_S , INSTRUCT_FCVT_L_S )
    // DECLARECASE(FUNCT7_FCVT_LU_S, INSTRUCT_FCVT_LU_S)
    // DECLARECASE(FUNCT7_FCVT_S_L , INSTRUCT_FCVT_S_L )
    // DECLARECASE(FUNCT7_FCVT_S_LU, INSTRUCT_FCVT_S_LU)
    DECLAREDEFAULTCASE(INSTRUCT_UNKNOWN)
  }
  break;
// RVC
